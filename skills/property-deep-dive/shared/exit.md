...
### 🇵🇪 Peru
- **DOM**: Lima (Miraflores / Barranco / San Isidro / Surco) ~120-200 / Cusco 150-300 / Arequipa 150-250 / regional 200-365+ [verify with SUNAT / Registros Públicos]
- **Commission**: **3-5% seller-pays typical** (Asociación Peruana de Profesionales Inmobiliarios) + 18% IGV (VAT) on commission
- **Contract**: corretaje exclusivo 3-6 mo; minuta de compraventa via notario público → Registros Públicos (SUNARP) registration
- **MLS**: NO MLS; **Urbania + Adondevivir + Properati** dominate; Lima-centric; agency-network beyond major brokers fragmented
- **Discount**: 10-20% off asking; Lima Miraflores prime narrower; 2024-2026 modest correction
- **Sell-side**: **Impuesto a la Renta 5% on gain** (residents + non-residents) under Art. 84 LIR — verify SUNAT; alternatively progressive PIT for residents; **alcabala 3% buyer-side**; commission 3-5% + 18% IGV; **foreign-seller can repatriate via SBS (Superintendencia de Banca, Seguros) banking channels**
- **Liquidity**: 🟠 MEDIUM Lima Miraflores / Barranco / San Isidro / Surco prime; 🔴 LOW Cusco / Arequipa; VERY LOW regional / sierra rural
- **Quirks**: **Border 50km Andean restriction (Constitution Art. 71)** — foreigners need Supreme Decree authorization for border-zone property; **Pacific Ring of Fire HIGH seismic + tsunami coastal + 2017/2023 El Niño catastrophic floods + huaicos + volcanic Misti/Ubinas/Sabancaya south**; STR Decree 001-2023 + Lima Miraflores/Barranco regs; coworking Comunal / WeWork / Selina Lima; PEN BCRP-managed but USD-pricing common Lima Miraflores prime; **Investor Visa USD 30k BUSINESS** (NOT real-estate exclusively) / **Rentista USD 1,500/mo passive** — see `visa-programs.md`; PR after 3yr continuous; passport after 2yr PR

### 🇪🇨 Ecuador
- **DOM**: Quito (La Floresta / Cumbayá / González Suárez) ~120-250 / Cuenca (Centro Histórico / Gringolandia) 100-180 (US/CA expat hub) / Guayaquil (Samborondón / Urdesa) 150-300 / Salinas / Olón coast seasonal 150-365 / regional 200-365+ [verify with SRI / Registro de la Propiedad]
- **Commission**: **3-5% seller-pays typical** (AEPI - Asociación Ecuatoriana de Promotores Inmobiliarios) + 12% IVA on commission
- **Contract**: corretaje exclusivo 3-6 mo; escritura pública via notario → Registro de la Propiedad municipal registration
- **MLS**: NO MLS; **Plusvalia + Inmobiliaria.com + Properati Ecuador** dominate; **Cuenca-specific portals** (Gringo Tree, Cuenca High Life classifieds) for expat market
- **Discount**: 10-20% off asking; Cuenca expat segment narrower (US/CA buyer demand stable)
- **Sell-side**: **Plusvalía Municipal sliding rate** on gain (varies by canton); national CGT integrated into PIT; commission 3-5% + 12% IVA; **alcabala 1% buyer-side**; **USD-dollarized since 2000** = no FX layer for USD-base sellers
- **Liquidity**: 🟢 MEDIUM Cuenca Centro Histórico / Gringolandia (**top US/CA expat retiree hub globally** per International Living indices — verify); 🟠 MEDIUM Quito La Floresta / Cumbayá; 🔴 LOW Guayaquil (post-2024 Internal Armed Conflict Declaration); VERY LOW regional / Salinas off-season
- **Quirks**: **2024 Internal Armed Conflict Declaration** (Decree 111) — violent crime peaks Guayaquil / Esmeraldas / Manta (Quito/Cuenca relatively safer); **Pacific Ring seismic (2016 Pedernales M7.8) + Cotopaxi volcano active 2024 + Galapagos rising sea-temp + tsunami coastal**; **USD-dollarized since 2000** (no native currency — political-economy reversion-risk overhang); STR Decreto 042-2020 Quito; coworking Selina / IMPAQTO Quito + Cuenca; **Pensioner Visa USD 1,500/mo** / **Investor Visa USD 42,500** (~100×SBU 2026 SBU USD 470/mo) — see `visa-programs.md`; 2yr Temporary → Permanent after 21mo; naturalization 3yr PR

### 🇵🇾 Paraguay
- **DOM**: Asunción (Carmelitas / Villa Morra / Las Lomas) ~150-300 / Encarnación 150-300 / Ciudad del Este 150-300 / Mennonite Chaco / interior 200-500+ [verify with SET / Dirección General de los Registros Públicos]
- **Commission**: **3-5% seller-pays typical** (informal market — broker law nascent) + 10% IVA on commission where applicable; some split
- **Contract**: bilateral sale agreement via escribano público → Dirección General de los Registros Públicos registration
- **MLS**: NO MLS; **Infocasas + Clasipar + ABC Color clasificados** dominate; agency-network beyond major Asunción brokers very thin
- **Discount**: 15-25% off asking; rural deeper; AR/BR buyer pool sensitive to cross-border FX cycle
- **Sell-side**: **Territorial PIT — foreign-source NOT subject to PY IRP** (residents and non-residents alike on PY-source only); **flat IRP 8/9/10%** on PY-source gain; ITBI ~1.5% buyer-side; commission 3-5% + 10% IVA; among lowest acquisition costs in LatAm
- **Liquidity**: 🟠 LOW-MEDIUM Asunción Carmelitas / Villa Morra / Las Lomas; 🔴 LOW Encarnación / Ciudad del Este; VERY LOW Chaco / Mennonite communities; **Itaipú/Yacyretá-driven data-center + cheap-energy demand** emerging segment
- **Quirks**: **Resolución SET 1186/2023 reformed PR** — formerly cheapest formal RBI in world (~USD 5,200) → now USD 70k SUACE business invest OR active SET RUC; citizenship 3yr continuous PR; **Río Paraguay flooding catastrophic 2014-15/2018/2019/2024 + Cerrado/Chaco wildfires 2019-20/2024 + drought**; minimal seismic; STR Decreto 8.771 (2017); coworking Loffice / CoLabora Asunción; **Itaipú/Yacyretá #2 net electricity exporter** (cheap energy attracts data centers); border 50km restriction Ley 2532/2005; PYG BCP-managed but USD widely accepted Asunción; Mennonite German + Portuguese border + Spanish + Guaraní co-official multilingual buyer pool
...
### 🇶🇦 Qatar
- **DOM**: Doha (West Bay / The Pearl-Qatar / Lusail / West Bay Lagoon) ~90-180 / Al Wakra / Mesaieed 150-300 / outside designated zones rare for foreigners [verify with MoJ Real Estate Registration]
- **Commission**: **2-3% seller-pays + 1-2% buyer-pays typical** + 5% VAT not yet implemented (Qatar VAT pending GCC framework — verify GAT)
- **Contract**: bilateral sale agreement → MoJ Real Estate Registration deed; designated freehold zones only for non-Qataris
- **MLS**: NO MLS; **Property Finder Qatar + Hapondo + Saakin** dominate; thin agency-network beyond major brokers
- **Discount**: 10-20% off asking 2024-2026 (post-FIFA World Cup 2022 oversupply digestion in some segments)
- **Sell-side**: **NO CGT** for individuals (NO PIT regime); ~0.25% transfer fee at MoJ Real Estate Registration; commission 2-3% + 5% if VAT enacted; **deed registration straightforward** for designated-zone freehold
- **Liquidity**: 🟠 MEDIUM Pearl-Qatar / West Bay Lagoon / Lusail prime; 🔴 LOW outside designated zones (foreigners can't buy elsewhere → buyer pool limited); FIFA World Cup 2022 legacy infra (Lusail metro) supports Lusail demand
- **Quirks**: **Foreigners limited to designated freehold zones** (Pearl-Qatar / West Bay Lagoon / Lusail) per Law 16/2018 — verify with MoJ Real Estate Registration; **NO citizenship-by-investment** (Law 38/2005 prohibits CBI); **Investor Residency Law 21/2018 ≥QAR 730k → 5yr renewable**; PR Law 10/2018 ≥QAR 1M (capped ~100/yr); QAR pegged USD 3.64 since Jul 2001; **88% expat population** creates dependency-on-residency dynamics; extreme heat 45°C+ + sandstorms + 2018/2021/2024 Doha storm-surge floods; Ooredoo / Vodafone Qatar 5G

### 🇸🇦 Saudi Arabia
- **DOM**: Riyadh (DQ / Olaya / Al Malaz) ~120-200 / Jeddah (Al Hamra / Corniche) 150-250 / NEOM / Red Sea / AlUla / Diriyah Vision 2030 zones — phased delivery / regional 200-365+ [verify with Real Estate General Authority]
- **Commission**: **2.5% seller-pays + 2.5% buyer-pays typical (Saudi Real Estate Brokers Code)** + 15% VAT
- **Contract**: bilateral sale agreement → Saudi Real Estate Registration; **Mecca/Medina Muslim-only constitutional restriction**
- **MLS**: NO MLS; **Bayut SA + Aqar + Wasalt** dominate; **Sahel STR licensing platform** for short-term rentals
- **Discount**: 5-15% off asking; Vision 2030 mega-project zones narrower
- **Sell-side**: **NO CGT** for individuals (NO PIT regime; Saudi Zakat 2.5% citizens / corporate 20% non-Saudi); **Real Estate Disposal Tax (RETT) 5% of sale value** (replacing prior VAT regime on resi); commission 2.5% + 15% VAT; deed registration straightforward
- **Liquidity**: 🟢 MEDIUM-HIGH Riyadh DQ / Olaya / Al Malaz prime + Jeddah Corniche; 🟠 MEDIUM Vision 2030 mega-project deliveries (NEOM / Red Sea / AlUla / Diriyah / Roshn — phased 2024-2030); 🔴 LOW secondary cities; **Mecca/Medina Muslim-only** — non-Muslim buyers barred entirely
- **Quirks**: **Mecca/Medina constitutional Muslim-only ownership** (non-Muslim foreigners barred from Holy Cities real estate entirely); **Premium Residency Vision 2030 SAR 800k one-time / SAR 100k/yr renewable / Real-Estate-Owner SAR 4M** — see `visa-programs.md`; SAR pegged USD 3.75 since Jun 1986; **Vision 2030 mega-projects (NEOM, Qiddiya, Diriyah, Red Sea, AlUla, Roshn)** drive employment + create concentration risk; Riyadh Metro Phase 1 launched Dec 2024; STC / Mobily / Zain 5G; **2009/2011 Jeddah catastrophic floods + 50°C+ summer + sandstorms + drought + groundwater depletion**; Tourism Law 2020 + Sahel STR licensing emerging
...
### 🇹🇳 Tunisia
- **DOM**: Tunis (La Marsa / Carthage / Sidi Bou Said / Les Berges du Lac) ~120-250 / Sousse (Boujaffar / Hammam Sousse) 150-300 / Hammamet 150-300 / Djerba seasonal 150-365+ / Sfax 200-365+ [verify with Direction Générale des Impôts]
- **Commission**: **2-3% seller-pays + 1-2% buyer-pays typical** (informal market — broker law nascent) + 19% TVA on commission; some seller-only at 3-5%
- **Contract**: bilateral sale agreement via notaire → conservation foncière registration; **Investor Residence Permit ≥TND 1M (~USD 320k)** for foreign-buyer residency
- **MLS**: NO MLS; **Tayara.tn + Mubawab.tn + Affare** dominate; agency-network thin beyond major Tunis/Sousse brokers
- **Discount**: 10-25% off asking; coastal and medina deeper; **post-2021 + IMF EFF Mar 2024 suspension overhang**
- **Sell-side**: **TPI (Taxe sur les Profits Immobiliers) 10-25% on net gain** (Code IRPP — verify Direction Générale des Impôts); minimum 2.5% of sale price (whichever higher); **exempt if primary residence held 5+ yrs**; commission 2-3% + 19% TVA; conservation foncière 1% buyer-side; **Office des Changes mandatory for FX repatriation** — without proper documentation foreign-seller proceeds locked in TND
- **Liquidity**: 🟠 MEDIUM Tunis La Marsa / Sidi Bou Said / Les Berges du Lac prime; 🔴 LOW Sousse / Hammamet seasonal; 🔴 LOW Djerba off-season; VERY LOW Sfax / interior; **medical-tourism + coastal FR/IT retiree demand** sustains premium-segment liquidity
- **Quirks**: **Office des Changes mandatory for repatriation** of sale proceeds — without proper documentation of original FX import, foreign-seller proceeds locked in TND (similar MA-style friction); **post-2021 constitutional revisions + 2024 elections** political-economy overhang; **IMF EFF program SUSPENDED Mar 2024** structural FX risk; **Tunisia Investor Visa drafted 2024 NOT gazetted** — verify gazette status; **2018 Cap Bon catastrophic floods + 2023-24 record drought (reservoirs <30%) + APAL coastal erosion**; STR Décret 2018-417; Tunisie Telecom / Ooredoo / Orange 4G/5G; coworking Cogite / Wikistage Tunis; **medical-tourism destination** (cosmetic surgery, dental, IVF) for FR/IT/MT clientele
...
### 🇯🇴 Jordan
- **DOM**: Amman (Abdoun / Sweifieh / Khalda / Dabouq / Deir Ghbar) ~120-250 / Amman secondary (Tla' Al Ali / Jubeiha / 7th Circle) 150-300 / Aqaba ASEZ seasonal 150-365 / Irbid / Zarqa 200-365+ / regional 200-500+ [verify with Jordan Department of Lands and Survey]
- **Commission**: **2-3% seller-pays + 1-2% buyer-pays typical** (informal market — broker law nascent) + 16% GST on commission; some seller-only at 3-5%
- **Contract**: bilateral sale agreement → Department of Lands and Survey (Da'irat al-Aradi wa al-Misaha) registration; **Council-of-Ministers approval required for properties >threshold (Greater Amman) or for specific nationalities** under reciprocity rules
- **MLS**: NO MLS; **OpenSooq Jordan + Wasalk + Beytuti + Real Estate Jordan** dominate; Arabic + English-medium listings in Amman expat zones
- **Discount**: 10-20% off asking; Aqaba/Dead Sea seasonal deeper; **post-2023 Israel-Hamas war regional spillover overhang**
- **Sell-side**: **CGT integrated into PIT** — progressive 5-30% on gain + 1% national-contribution (2026 — verify ISTD); commission 2-3% + 16% GST; Lands Department registration ~9% **(SPLIT 50/50 between buyer + seller typical)**
- **Liquidity**: 🟠 MEDIUM Amman Abdoun / Sweifieh / Khalda / Dabouq prime (large GCC + Iraqi+Syrian+Palestinian diaspora demand); 🔴 LOW Amman secondary; 🔴 LOW Aqaba off-season; VERY LOW Irbid / Zarqa / regional; **medical-tourism + GCC+Iraq+Syria+Palestinian diaspora demand** sustains Amman premium-segment liquidity
- **Quirks**: **CBI Jordan since 2018** — JOD 750k bond OR JOD 1M private investment OR JOD 250k SME with 20+ employees → Jordanian passport (~50 visa-free destinations — WEAK passport for mobility plays, rational mainly for diaspora reconnection / GCC business utility); **Investor Residence ≥JOD 200k Greater Amman / JOD 100k outside (5yr renewable)**; Bona Fide Investor ≥JOD 50k bank deposit 1+yr; Aqaba ASEZ separate framework; **Council-of-Ministers approval required** for properties >threshold or for specific nationalities under reciprocity rules; ≤4,000 m² agricultural barred; **among most water-poor globally per FAO + Disi aquifer depletion + Dead Sea shrinking ~1m/yr**; Zain / Orange / Umniah 5G; coworking ZINC / Beit Al Bawadi / Centro Connect Amman; medical-tourism hub (King Hussein Cancer Center, Specialty, Istishari, Al-Khalidi); JOD pegged USD 0.708 since Oct 1995

### 🇴🇲 Oman
- **DOM**: Muscat (Al Mouj / The Wave / Madinat Al Sultan Qaboos / Qurum / Shatti Al Qurum / Al Khuwair) ~150-300 / Salalah Khareef-zone (Jul-Sep peak) 150-365 / Nizwa interior 200-365+ / Sohar / Sur 200-500+ [verify with Ministry of Housing and Urban Planning / Royal Oman Police]
- **Commission**: **2-3% seller-pays + 1-2% buyer-pays typical** (informal market — broker law nascent) + 5% VAT on commission; some seller-only at 3-5%
- **Contract**: bilateral sale agreement → Ministry of Housing and Urban Planning registration; **foreigners limited to Integrated Tourism Complexes (ITC)** designated zones per Royal Decree 12/2006 / 89/2021 (e.g. The Wave / Muscat Hills / Saraya Bandar Jissah / Hawana Salalah)
- **MLS**: NO MLS; **Property Finder Oman + Bayut Oman + OpenSooq + Aqarmap Oman** dominate; thin agency-network beyond major brokers
- **Discount**: 10-20% off asking; Salalah seasonal deeper; **CYCLONE EXPOSURE HIGH** (Gonu/Mekunu/Shaheen/Tej) widens insurance underwriting baseline + discount expectations
- **Sell-side**: **NO CGT** for individuals (NO PIT regime — Oman individual income-tax law drafted 2022 NOT enacted as of May 2026 — verify Tax Authority); ~3% transfer fee at MoH-Urban Planning + 1% legal + agent 2-3% + 5% VAT on services
- **Liquidity**: 🟠 MEDIUM Muscat Al Mouj / The Wave / Madinat Al Sultan Qaboos / Qurum prime ITC zones; 🔴 LOW Salalah seasonal (Khareef-driven); 🔴 LOW Nizwa interior; **outside designated ITC zones — foreigners cannot buy** = buyer pool limited; UK/IN/PK/SA/EG/JOR expat retiree demand sustains ITC prime
- **Quirks**: **Foreigners limited to Integrated Tourism Complexes (ITC) designated zones** per Royal Decree 12/2006 / 89/2021; **Investor Residency Royal Decree 89/2021** — 5-yr ≥OMR 250k (~USD 650k) ITC freehold / 10-yr ≥OMR 500k (~USD 1.3M) ITC; **Long-term Retiree Residence ≥OMR 4,000/mo pension (~USD 10,400)**; **NO citizenship-by-investment** (Omani nationality strict); OMR pegged USD 0.385 since 1986; ~5.0M pop (Muscat Metro 1.7M, ~38% expat); Vision 2040; **CYCLONE EXPOSURE HIGH** — Gonu 2007 / Phet 2010 / Mekunu 2018 / Shaheen 2021 / Tej 2023 catastrophic Muscat coast (insurance underwriting baseline); Salalah unique Khareef Jun-Sep monsoon — only verdant zone in Arabian Peninsula; quieter than UAE — appeals to retirees seeking less commercial GCC; Omantel / Ooredoo Oman 5G; coworking Ihroz / Oman Tech Fund / Spaces Muscat — see `visa-programs.md`

### 🇧🇭 Bahrain
- **DOM**: Manama (Seef / Diplomatic Area / Juffair / Adliya / Saar) ~90-180 / Amwaj Islands ~120-250 / Diyar Al Muharraq ~120-250 / Reef Island / Bahrain Bay 120-250 / Riffa / Hamad Town 150-300 / regional 200-365+ [verify with Survey & Land Registration Bureau / SLRB]
- **Commission**: **2-3% seller-pays + 1-2% buyer-pays typical** (RERA Bahrain regulated since 2017) + 10% VAT (Jan 2022 increase from 5%) on commission; some seller-only at 3-5%
- **Contract**: bilateral sale agreement → Survey & Land Registration Bureau (SLRB) registration; **foreigners limited to designated freehold zones** — Diyar Al Muharraq / Amwaj Islands / Durrat Al Bahrain / Reef Island / Bahrain Bay / Seef / Manama Diplomatic Area
- **MLS**: NO MLS; **Property Finder Bahrain + Bayut Bahrain + OpenSooq Bahrain + Weetas** dominate; agency-network thin beyond major brokers
- **Discount**: 5-15% off asking; oversupply in some Amwaj/Reef Island pockets deeper
- **Sell-side**: **NO CGT** for individuals (NO PIT regime); ~2% transfer fee at SLRB + 0.5% deed registration + agent 2-3% + 10% VAT on services; **deed registration straightforward** for designated-zone freehold
- **Liquidity**: 🟠 MEDIUM Manama Seef / Diplomatic Area / Amwaj Islands / Reef Island prime (Saudi Causeway weekend foot-traffic + UK/US/IN/PK/SA expat demand); 🔴 LOW outside designated zones (foreigners can't buy elsewhere → buyer pool limited); 🔴 LOW Riffa / Hamad Town
- **Quirks**: **Foreigners limited to designated freehold zones** — Diyar Al Muharraq / Amwaj Islands / Durrat Al Bahrain / Reef Island / Bahrain Bay / Seef / Manama Diplomatic Area; **Bahrain Property Visa Decree 6/2017 ≥BHD 200k (~USD 530k) → 10-yr renewable Self-Sponsored Residence Permit (incl. spouse + children)**; **Golden Residency Decree 16/2022** 10-yr renewable for property owners ≥BHD 200k OR investors / talented / retirees (BHD 4k/mo); **NO CBI**; BHD pegged USD 0.376 since 1980; ~1.49M pop (~52% Bahraini + 48% expat); Saudi Causeway integration drives weekend medical-tourism flow (King Hamad Causeway 2 planned); banking + financial services hub historically; quieter than UAE — appeals to mid-tier investors; Batelco / Stc / Zain Bahrain 5G; coworking Bru Coffee / Brinc / CoLab Manama; SEHATI mandatory + supplemental; King Hamad University Hospital / American Mission Hospital / Bahrain Specialist / Al Salam — see `visa-programs.md`

### 🇰🇼 Kuwait
- **DOM**: Kuwait City (Salmiya / Salwa / Mishref / Bayan / Salwa / Yarmouk) ~150-300 / Hawalli ~120-250 / Mahboula / Mangaf 150-300 / regional 200-500+ [verify with Public Authority for Civil Information / MoJ]
- **Commission**: **2-3% seller-pays typical** (informal market — broker law nascent) + 5% VAT not yet implemented (Kuwait VAT pending GCC framework — verify); some split or buyer-only
- **Contract**: bilateral sale agreement → Ministry of Justice property registration; **foreigners CANNOT own real estate freehold** — only via 5-yr leasehold via Iqama-employer-sponsored arrangements (Decree-Law 74/1979 / 8/2008 amendments)
- **MLS**: NO MLS; **OpenSooq Kuwait + Aqarat / Aqar.com Kuwait + Property Finder Kuwait** dominate; Arabic + English business-language listings
- **Discount**: 10-20% off asking; oil-revenue-correlated cycle; periodic political deadlock (parliament dissolved 2024) creates uncertainty
- **Sell-side**: **NO CGT** for individuals (NO PIT regime); ~2% transfer fee at MoJ + 0.5% legal + agent 2-3%; **but transfers between non-citizens are STRUCTURALLY restricted** (Decree-Law 74/1979 / 8/2008)
- **Liquidity**: 🔴 VERY LOW for foreign ownership generally — **foreigners CANNOT own real estate freehold** — only Iqama-employer leasehold; 🟠 MEDIUM for Kuwaiti citizens in Kuwait City Salmiya / Salwa / Bayan / Mishref prime; 🔴 LOW everywhere else; market structurally bifurcated citizen-only freehold vs employment-tied leasehold
- **Quirks**: **NO golden-visa via real estate (UNIQUE absence in GCC)** — residency entirely via employment Iqama (Decree-Law 17/1959); **foreigners CANNOT own real estate freehold** — only 5-yr leasehold via Iqama-employer-sponsored arrangements (Decree-Law 74/1979 / 8/2008 amendments); citizenship effectively impossible (Decree-Law 15/1959); **Bedoon stateless population pressing issue**; KWD highest-valued currency globally — pegged to undisclosed basket weighted toward USD by CBK; ~4.85M pop (~30% Kuwaiti + 70% expat — largest IN/EG/BD/PH/SY); among hottest inhabited capitals 8-49°C **summer 50°C+ near-uninhabitable May-Sep + sandstorms (Toz / shamal)**; Vision 2035; periodic political deadlock (parliament dissolved 2024 — temporary suspension); Zain / STC Kuwait / Ooredoo 5G; coworking Spaces / Sirdab / 360 MALL coworking; mandatory Afya health-card system 2016+ for expats + KD 50/yr healthcare-fee; **among the most restrictive globally on foreign property ownership** — see `visa-programs.md`

### 🇱🇧 Lebanon
- **DOM**: Beirut (Achrafieh / Verdun / Hamra / Mar Mikhael / Gemmayzeh / Sodeco / Saifi Village) ~150-365+ / Mount Lebanon (Broummana / Beit Mery / Bsalim / Antelias / Jounieh) 200-365+ / Byblos / Jbeil 200-365+ / Tripoli 200-500+ / Cedars ski-zone seasonal 200-365+ / regional 250-700+ [verify with Direction Générale du Cadastre]
- **Commission**: **2-3% each side typical** (informal market — broker law nascent) + 11% VAT on commission where applicable; some split or seller-only
- **Contract**: bilateral sale agreement via notaire → Direction Générale du Cadastre registration; **foreign-buyer aggregate-area limits** — ≤3,000 m² aggregate Beirut / ≤10,000 m² aggregate Mount Lebanon / coastal limits; Council-of-Ministers approval for >limits; Lebanese-descent buyers exempt
- **MLS**: NO MLS; **OLX Lebanon + Tayyar / Property Finder Lebanon + L'Orient-Le Jour clasificados + Lebnen** dominate; Arabic + French + English-medium listings in Beirut expat zones
- **Discount**: 20-40% off asking 2024-2026 (catastrophic post-2019 banking collapse + 2020 Beirut Port explosion + 2024 Israel-Hezbollah war); **dual-pricing USD ↔ LBP** (banking-frozen USD vs fresh-USD distinction critical)
- **Sell-side**: **CGT 15% on gain** for individuals (verify MoF Lebanon); commission 2-3% + 11% VAT; cadastre registration ~5-6% + 0.5% legal + 1% notarial; **fresh-USD vs banking-frozen USD distinction critical** for net proceeds — material to exit math
- **Liquidity**: 🔴 VERY LOW Beirut Achrafieh / Verdun / Hamra prime (post-2019 banking collapse + 2020 Beirut Port explosion + 2024 Israel-Hezbollah war Sep-Nov 2024 cascading liquidity collapse); 🔴 VERY LOW everywhere else; **Lebanese diaspora returnee** demand (~13M Mahjar — US/CA/AU/FR/BR/AR dominant) is the entire foreign-buyer cohort; foreign-buyer aggregate-area limits + Council-of-Ministers approval for >limits narrow buyer pool further
- **Quirks**: **Foreign-buyer aggregate-area limits** — ≤3,000 m² aggregate Beirut / ≤10,000 m² aggregate Mount Lebanon / coastal limits per Decree 11614/1969 amendments; Council-of-Ministers approval for >limits; **Lebanese-descent buyers exempt** (massive practical advantage for Mahjar diaspora); NO golden-visa via real estate; **Investor Residency ≥USD 50k Lebanese business (1-yr renewable)**; property ownership ≥USD 200k can support residency application but not automatic; **Lebanese descent streamlined naturalization** (~13M global Mahjar diaspora — far larger than 5.5M domestic); dual citizenship since 2007; **post-2019 banking collapse + 2020 Beirut Port explosion + 2024 Israel-Hezbollah war Sep-Nov 2024**; **LBP catastrophic collapse 2019-2026** — official vs Sayrafa vs parallel rate triple-tier; banking-sector restrictions on USD withdrawals + transfers; **dual-pricing USD ↔ LBP** in property contracts (fresh-USD vs banking-frozen USD distinction critical); Touch + Alfa 4G ageing — **NO 5G yet**; coworking Antwork / Coworking + Co / JoiBox / Cloud9 — operating with USD-LBP dual-pricing; healthcare collapse since 2019 — historical AUB/Hôtel-Dieu de France standard now medivac to CY/IT/FR for fresh-USD-paying patients; Cedars ski-zone unique to Middle East; Beirut Mediterranean 11-30°C / Mount Lebanon altitude-cooler
