...
**Snapshot**: May 2026 (Crown Deps + DK territories + NL Caribbean additions — 121 countries total).
...
| Caribbean | [`exit/caribbean.md`](./exit/caribbean.md) | DO, JM, BS, BB, BZ, KY, BM, TC, VG, KN, AG, LC, GD |
...
18. **CBI-recyclability as a structural liquidity feature/risk**: **KN (7-yr hold, resale-to-next-CBI-applicant, early resale breaks recyclability)**, **AG/LC/GD (5-yr hold)** — the resale market on CBI-approved developments is partly driven by the next CBI applicant; CBI-floor asking prices (KN ~US$325k / AG/LC US$300k / GD US$270-350k) are regulatory floors, NOT market-clearing valuations; **guaranteed buy-backs/rebates PROHIBITED in GD (2024) — treat fixed-yield/guaranteed-resale CBI offers as a red flag**
