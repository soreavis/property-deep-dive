...
Currency code, peg status, FX volatility, capital controls, hedging market depth, 2025-26 currency reforms across all 71 supported countries.

**Snapshot**: April–May 2026 (Tier-3 additions: SG, HK, KR, TW, LI, MO, AD, MC, MD).
...
Last refreshed: 2026-05-01 (Tier-1 expansion: US, TR, AE, JP, TH, DO, CO, UY, CL, ZA + Tier-2: GE, ID, MY, VN, PH, IL, MA, EG + **Tier-3: SG, HK, KR, TW, LI, MO, AD, MC, MD**). Next refresh: monthly (rates), per-event (regime change, peg adjustment, mandatory-FX-form rule changes).

**Confidence**: HIGH for peg / regime status (verified to central-bank sources — CBE, BAM, BoT, SBV, BI, BNM, BSP, NBG, SARB, BoJ, BoI, CBUAE, BCRD, BCCh, BCU, BCU UI, BanRep, MAS, HKMA, BoK, CBC, AMCM, FMA, INAF, BNM-Moldova, 2002 Monaco Monetary Convention, 2011 Andorra Monetary Treaty, 1923 LI-CH Customs Treaty, 1983 HKD LERS, 1983 MOP-HKD peg). MEDIUM for live point-in-time FX rates (verify daily before transaction); MEDIUM for capital-control fine-print (verify per-deal with authorised bank + lawyer).
