...
## 🇸🇲 San Marino
- **DOM**: Città di San Marino (UNESCO historic centre) ~120-300+ (preservation-zone constraints — long absorption) / Borgo Maggiore + Serravalle (commercial / largest castelli) 90-180 / Domagnano / Acquaviva / Faetano residential 90-180 / Fiorentino / Chiesanuova / Montegiardino smaller 150-300+ [verify with UTCC + Conservatoria dei Registri Immobiliari]
- **Commission**: **3-5% seller-pays typical** (Italian-influenced civil-law tradition; agency regulation evolving) + 17% Imposta Monofase on commission where applicable
- **Contract**: bilateral contratto preliminare → atto pubblico before notaio → registration at Conservatoria dei Registri Immobiliari + UTCC cadastre update; **2-property cap per foreign individual** (Legge 173/2018)
- **MLS**: NO formal MLS; **Italian-listings overflow Rimini-Riccione corridor common** (Idealista IT / Immobiliare.it / Casa.it routinely cross-list SM properties); domestic small-broker network thin given ~34k pop
- **Discount**: 5-15% off asking typical; small-market thin pool means individual-property negotiating leverage variable; **IGR 2026 reform** (verify gazetted text) creates short-term price-discovery distortion
- **Sell-side**: **CGT included in IGR (Imposta Generale sui Redditi)** — residency-dependent rates; primary residence + holding-period exemptions per IGR 2026 reform pending; commission 3-5%; notaio ~1.5% + Conservatoria registration ~1%; Imposta Monofase 17% first-sale developer (VAT-equivalent)
- **Liquidity**: 🟠 MEDIUM Borgo Maggiore + Serravalle commercial + cross-border-commuter residential (Italian Rimini-Riccione 30-min); 🟠 LOW-MEDIUM Città di San Marino UNESCO historic centre (preservation constraints + tourism rental yield); 🔴 LOW outer castelli (Fiorentino / Chiesanuova / Montegiardino); VERY LOW rural; thin secondary market
- **Quirks**: **Legge 173/2018 abolished prior authorization regime** for foreign acquisition; **2-property cap per foreign individual** (vs unlimited Sammarinese citizens / pre-2018 1-property cap); **EUR adopted via 2000 Monetary Convention with EU** (NOT Eurozone-member, but EUR sole legal tender — coins minted with SM motifs); **IGR 2026 reform** pending (verify gazetted text); **NO inheritance tax for direct relatives** + 4-8% sliding for others; BCSM-licensed local banks (BAC, BSI, Cassa di Risparmio di San Marino) limited LTV 60-70% non-residents; **Italian-citizenship-by-descent + 30-yr continuous residence naturalisation** (NOT investment-pegged); UNESCO World Heritage historic centre + Mount Titano (preservation-zone constraints on alterations); landlocked enclave within Emilia-Romagna + Marche; minimal natural risk — Apennine seismic Zone 3 moderate (1980 Irpinia M6.9 felt); ~33,987 pop (Ufficio Statistica Sept 2024); 9 castelli; Italian official; **Confidence HIGH** for legal regime + 2-property cap
