...
Per-country property insurance landscape across all 54+ supported countries (Tier-1: AE, CL, CO, DO, JP, TH, TR, US, UY, ZA + Tier-2: EG, GE, ID, IL, MA, MY, PH, VN added April 2026): catastrophic-risk reinsurance schemes, flood/earthquake availability, ballpark premium %, mortgage-mandatory rules, 2025-26 climate-risk reforms.
...
Last refreshed: 2026-05-01 (Tier-1 + Tier-2 expansion: US, TR, AE, JP, TH, DO, CO, UY, CL, ZA, GE, ID, MY, VN, PH, IL, MA, EG added). Next refresh: per-event (each cat-risk scheme reform); annually otherwise. **High-volatility rows** (re-verify before quoting): IL (active war), AE (post-flood market), EG (post-devaluation), US (state insurer-exit churn), TR (DASK cap re-set).
