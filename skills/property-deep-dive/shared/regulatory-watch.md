...
- `2026-04-15 (consultation CLOSED 15 Jul 2026; not enacted) | rental foreign-buyer | Federal Council opened Vernehmlassung to tighten Lex Koller (BewG) — third-country nationals permit-liable for main residences (duty to sell within 2 yrs of moving away), holiday-home purchases restricted, business real estate barred if intended for rent/lease (own-use stays free), new ban on foreign acquisition of listed housing-company shares and regularly-traded real-estate fund/SICAV units; accompanying measure adopted Jan 2025 alongside Federal Council's recommendation to reject the Keine-10-Millionen-Schweiz initiative (initiative vote still pending). Consultation closed on schedule 15 Jul 2026; submissions (Kantone/Parteien/Organisationen) published 27 Jul 2026; Federal Council now evaluating — no Ergebnisbericht or Botschaft yet | admin.ch Medienmitteilung 15 Apr 2026 + bj.admin.ch Revision Lex Koller (submissions publ. 27 Jul 2026) | 2026-08-05 | 2026-11-15 | 2 | --rental --visa --foreign-buyer (CH)`
...
- `2026-05 draft JMD; signature targeted end-Jun 2026, NOT signed as of 6 Aug 2026 | rental | Cyclades 20-30% tourist-bed cut + STR/Airbnb conversion freeze in saturated red-zone islands (Mykonos/Santorini et al.) — provisions of the DRAFT Special Spatial Framework for Tourism (JMD by Tourism Min. Kefalogianni + Environment Min. Papastavrou). Draft JMD published 11 May 2026, consultation closed 25.05.2026 per the YPEN page, signature targeted end-June 2026 — that target has passed and YPEN's own SSFT page still carries only the consultation notice (checked 2026-08-06). STILL UNENACTED — do NOT assert any live bed-cap or Mykonos STR freeze until the JMD is gazetted. NB the draft's short-term-rental restrictions are not self-executing: the text states they require separate legislative/regulatory provision | Greek Ministry of Environment and Energy (YPEN) — `https://ypen.gov.gr/eidiko-chorotaxiko-plaisio-gia-ton-tourismo/` + news.gtp.gr `https://news.gtp.gr/2026/05/11/greeces-new-tourism-spatial-framework-new-rules-for-investments-and-development/` | 2026-08-06 | 2026-09-07 | 1 | --rental`
...
- `2026-09-11 | connectivity | Hague Apostille convention enters into force for VN — POA chain shifts from full consular legalisation to apostille; BUT Germany (20 May), Austria (19 Jun), Czechia (2 Jul 2026) objected under Art. 12(2) → Convention NOT in force between VN and those 3 states (consular legalisation persists pairwise); calendar-actionable flip of shared/language.md + shared/remote.md + vn playbook on 11 Sep 2026 | HCCH status table (cid=41, VN Type=Objection) + Vietnam MFA | 2026-08-05 | 2026-09-15 | 2 | --connectivity --language --remote`
...
- `2026-07-24 | macro | NBK base rate cut 25 bps to 16.75 percent on 24 July 2026 (from 17.0 percent) — second consecutive cut after the 5 June 2026 100 bps cut (18.0→17.0); ninth straight month of easing inflation; decision surprised markets expecting a hold; instrument is officially the base rate (базовая ставка), not "refinancing rate"; ±1 pp corridor; CPI eased to 10.2 percent July 2026 (10.3 June); NEXT RATE DECISION 4 September 2026 | NBK Governor Suleimenov statement 24 Jul 2026 (nationalbank.kz/en/news/informacionnye-soobshcheniya/19988, primary) + Astana Times + TradingEconomics + Central Banking | 2026-08-05 | 2026-09-08 | 3 | --currency --macro (KZ)`
...
- `2026 income year | tax | Personal Income Tax band reduction CONFIRMED and in force for income year 2026 — 12.5% → 11.5% on income above BBD 25,000 up to BBD 75,000, and 28.5% → 27.5% above BBD 75,000; BBD 25,000 personal allowance unchanged. Announced in the 2026/2027 Budget on 16 Mar 2026 by Minister of Finance Ryan Straughn; rates set out in BRA Policy Note OGC No. 001/2026 (April 2026), which is the administering authority's own statement of the operative rates. 2025 schedule was 12.5% / 28.5% | Barbados Revenue Authority Policy Note OGC No. 001/2026 — `https://bra.gov.bb/News/Policy-Notes/Reduction-of-Personal-Income-Tax-R` | 2026-08-06 | 2027-03-01 | 2 | --tax`
...
- `2026-06-03 | tax | Capital Gains Tax rate increase ENACTED — Inland Revenue (Amendment) Act, No. 11 of 2026, certified 3 June 2026 and published as a supplement to Part II of the Gazette of 5 June 2026, raises CGT on realisation of investment assets from 10% to 15% for individuals and partnerships and from 10% to 30% for trusts, unit trusts, mutual funds and NGOs. IRD Notice to Taxpayers SEC/PN/IT/2026/02 (8 June 2026) states the new rates apply from 3 June 2026. SUPERSEDES the prior "10% statutory, 15% proposed" position — quoting 10% for a post-3-Jun-2026 disposal is now wrong | Inland Revenue (Amendment) Act No. 11 of 2026 — `https://documents.gov.lk/view/act/2026/6/11-2026_E.pdf` + IRD Sri Lanka `https://www.ird.gov.lk/en/Type%20of%20Taxes/SitePages/Capital%20Gain%20Tax%20(CGT).aspx` | 2026-08-06 | 2027-01-01 | 1 | --tax --exit`
...
- `2025-12-06 to 2026-06-05 | tax | 16th Tourism Act Amendment discounted resort head-lease-extension window LAPSED on its scheduled 5 Jun 2026 end date (ratified 6 Dec 2025; closure now CONFIRMED against the Ministry of Tourism's own legislation register, which lists amendments to the Tourism Act through the 16th and no 17th as of 2026-08-06 — no Ministry post-deadline outcome statement located). The discounted ~USD 5M (49-yr) / USD 2.5M-3M (20/25-yr) rate reverts post-window to the higher default schedule (~USD 10M reference for a 49-yr extension) — verify the binding post-window fee with the Ministry implementing regulation. NB this was the 3rd serial re-opening of the discount (prior windows to ~Feb-2025, then Sep-2025) so a 17th-Amendment renewal is possible per precedent | Ministry of Tourism Maldives `https://www.tourism.gov.mv/dms/document/23d485632704b30cf178db46d41f0bff.pdf` + CTL Strategies `https://www.ctlstrategies.com/latest/tourism-act-16th-amendment/` + Ministry of Tourism amendment register `https://www.tourism.gov.mv/en/legislation/tourism_act` | 2026-08-06 | 2026-12-01 | 1 | --tax --exit`
- `2025-07-01 (TGST); Green Tax 2025-01-01 | tax | CORRECTION to the prior entry, which dated both measures to 1 Jan 2025. TGST (Tourism Goods and Services Tax) rose 16% → 17% effective **1 July 2025**, not 1 Jan 2025 — Seventh Amendment to the Goods and Services Tax Act (Act 20/2024), ratified 5 Nov 2024 with a transitional period to 1 Jul 2025. Green Tax doubled effective **1 January 2025** (Fourteenth Amendment to the Tourism Act, Act 21/2024): USD 12/person/night at resorts, tourist hotels and safari vessels and USD 6 at guesthouses (the USD 12 figure is NOT uniform — the guesthouse tier matters for guesthouse yield models); children under 2 exempt. Both still current as of 2026-08-06 | MIRA Maldives Inland Revenue Authority — `https://www.mira.gov.mv/Pages/View/gst` + Crowe Maldives `https://www.crowe.com/mv/insights/overview-of-the-amendments-on-tgst-grt-and-airport-taxes-and-fees` | 2026-08-06 | 2027-01-01 | 2 | --tax --rental`
...
- `2026-07-27 | macro | IMF Extended Credit Facility CONCLUDED — the Executive Board completed the sixth and final review on 27 July 2026, clearing a final disbursement of about USD 371 million. The USD 3 billion 36-month ECF (approved 17 May 2023, extended three months to 16 Aug 2026) is over, and Ghana has moved to a 36-month non-financing **Policy Coordination Instrument** — technical assistance and reform monitoring, no further Fund money. SUPERSEDES the prior "ongoing programme, quarterly milestones" framing: GHS managed-float commentary must no longer be written as programme-conditioned. Ghana's Presidency announced the exit on 15 May 2026 at staff-level agreement | IMF Country Report No. 2026/212, 4 Aug 2026 — `https://www.elibrary.imf.org/view/journals/002/2026/212/002.2026.issue-212-en.xml` + Presidency of Ghana `https://presidency.gov.gh/ghana-successfully-completes-imf-bailout-programme-transitions-to-policy-coordination-instrument` + Reuters 27 Jul 2026 | 2026-08-06 | 2026-11-01 | 1 | --macro --currency --finance`
...
## EU-wide instruments — transposition and application dates

A **directive** binds all 27 member states but reaches a buyer only through national law; the transposition deadline is the date by which that national law must exist. A **regulation** applies directly, so its application date is the date it bites. Every row below was read off the instrument's own EUR-Lex text on the verified date — do not restate a deadline from memory.

| Instrument | Topic | Deadline / application | Status (verified 2026-07-31) | Affected sections |
|---|---|---|---|---|
| **(EU) 2024/1275** (EPBD recast, directive) | Energy performance — zero-emission buildings, MEPS, mandatory renovation passports | Transposition **29 May 2026**; art. 17(15) (no financial incentives for stand-alone fossil-fuel boilers) was due earlier, **1 Jan 2025** | **Deadline passed, unmet everywhere** — on 15 Jul 2026 the Commission opened infringement procedures with letters of formal notice to **all 27** member states for failing to fully transpose; two months to respond, then a possible reasoned opinion ([DG ENER, 15 Jul 2026](https://energy.ec.europa.eu/news/commission-calls-eu-countries-transpose-reinforced-rules-energy-performance-buildings-2026-07-15_en)) | `--esg` `--rental` |
| **(EU) 2024/1028** (regulation) | Short-let data collection + registration harmonisation | Directly applicable, **applies 20 May 2026** — a single date, no later tranche; member states had to adopt the penalty provisions by the same date; Commission evaluation due by 20 May 2031 (art. 18) | In application since 20 May 2026 | `--rental` |
| **(EU) 2024/1640** (AMLD6, directive) | Beneficial-ownership registers + access rules; **art. 18 single access point to real-estate information** | Main transposition **10 Jul 2027**. Derogations (art. 78): art. 74 by 10 Jul 2025 · **arts. 11, 12, 13 and 15 — BO-register access, incl. legitimate-interest access — by 10 Jul 2026** · **art. 18 by 10 Jul 2029** | 10 Jul 2026 access tranche now due; main deadline pending | `--tax` (ownership) `--finance` |
| **(EU) 2023/2226** (DAC8, Council directive) | Crypto-asset reporting | Adopt + publish by **31 Dec 2025**, apply from **1 Jan 2026**; two later tranches — 31 Dec 2027 (apply 1 Jan 2028) and 31 Dec 2029 (apply 1 Jan 2030) | First tranche in application since 1 Jan 2026; per-country transposition not individually verified | `--tax` |
| **(EU) 2024/1689** (AI Act, regulation) | High-risk AI — incl. systems that **evaluate creditworthiness or establish a credit score** of natural persons (annex III, 5(b)), i.e. mortgage decisioning | Directly applicable. General application **2 Aug 2026**; chapters I–II from 2 Feb 2025; chapter III section 4, V, VII, XII + art. 78 from 2 Aug 2025; art. 6(1) (the annex I product-safety route) deferred to 2 Aug 2027. Annex III systems are high-risk under **art. 6(2)**, so they follow the general date | Annex III high-risk obligations apply from 2 Aug 2026 | `--finance` |
| **(EU) 2023/1791** (EED recast, directive) | Energy efficiency | Transposition **11 Oct 2025**; applies from 12 Oct 2025 (art. 37 from 30 Jun 2024) | Deadline passed. **Supersedes Directive 2012/27/EU** — which Directive (EU) 2018/2002 amended — repealed with effect from 12 Oct 2025 (art. 39); cite the recast, never 2018/2002 | `--esg` |
...
**Rule**: For any EU country playbook's `--esg` or `--rental` section, EPBD recast 2024/1275 must be referenced if the section claims any energy-rating rental ban schedule. Since 15 Jul 2026 **no member state has fully transposed it** (all 27 hold a letter of formal notice), so never present an EPBD requirement as if it already bound an owner in a given country — cite the *national* law that exists today, and name the directive only as the source of the obligation to legislate. A national rental-ban schedule that predates the recast (e.g. the FR DPE ladder) stands on its own national footing and is unaffected by this.

**Rule**: The AI Act's high-risk obligations for creditworthiness/credit-scoring systems (annex III, 5(b) → art. 6(2)) apply from **2 Aug 2026**. They bind the *provider and deployer* of the scoring system — a bank, not the buyer — so a `--finance` section may note that a mortgage decision made by an automated system now carries transparency and human-oversight duties, but must not imply the buyer gains a direct claim or that a specific lender is non-compliant.
