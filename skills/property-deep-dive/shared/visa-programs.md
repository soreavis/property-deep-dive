...
| EG | Investment Law 160/2023 — Cash Deposit RBI | OPEN — RECENT | **USD 250,000** non-refundable cash deposit (5-yr) → permanent residency | No | Permanent residence after 5-yr | Not direct citizenship; verify with GAFI before transferring |
...
GR (€800k/€400k/€250k tiers, 120 sqm), CY PR (€300k), LV (€250k Riga radius, built only), MT MPRP (verify post-ECJ), RS / BA (no min, habitable), ME (€150k tax-assessed, since 17 Jan 2026), BR (BRL 700k N/NE; BRL 1m elsewhere), CR (US$150k incl. RE), PA Friendly Nations (US$200k) / Qualified Investor (US$300k), NZ AIP (after AIP residency, min NZD 5m), **TR CBI (USD 400k)**, **AE Golden Visa (AED 2M)**, **DO Investor Residency (USD 200k)**, **CO Migratorio M (350× SMLMV ~USD 125k)**, **UY Tax-Residency (UI 3.5M ~USD 470k)**, **AE Retirement Visa (AED 1M property)**, **ID Second Home Visa (IDR 2B deposit; property-route value contested — verify at Imigrasi)**, **EG Real-Estate CBI (USD 300k)** + **EG Golden Residency (USD 100k/200k/400k tiers)**, **GE Investor Residence (USD 300k)**, **BB SERP Cat. 2 (USD 300k)**, **LK Golden Paradise (USD 75k condominium route)**, **MV Resort sub-lease / branded-residence** (lease right not residency), **UZ real-estate-for-residence route (UP-5611; USD 300k Tashkent / 200k regions / 100k other — separate from the 5-yr Golden Visa, which is a USD 250k payment with no RE condition)**.
...
ES Golden Visa (Apr 2025), IE IIP (Feb 2023), PT Golden Visa via RE (Oct 2023), CY CBI (Nov 2020), BG CBI (Apr 2022), HU RE option (Jan 2025), AU SIV (Jul 2024), UK Tier 1 (Feb 2022), MT MEIN (ECJ Apr 2025), **TH 99-yr lease + 75% condo quota** (proposed 2024-25 — NOT enacted as of May 2026), **VN Golden Visa via real estate** (NEVER OFFERED — DT visa requires enterprise capital, not RE), **IL RBI/CBI** (NEVER OFFERED — Aliyah is the predominant route, Jewish-descent only), **KZ Golden Visa via RE** (NEVER OFFERED — REAL ESTATE EXPLICITLY EXCLUDED from US$300k Investor Visa qualifying assets), **JM RBI/CBI via RE** (NEVER OFFERED — foreign-ownership PARITY but no statutory residence-by-investment), **BB CBI** (NEVER OFFERED — distinguishes from KN/DM/AG/LC/GD), **LK CBI** (NEVER OFFERED — naturalisation requires long residence + Sinhala/Tamil language test), **MV CBI** (NEVER OFFERED — Muslim-faith adherence + 12-yr residence required for naturalisation; non-Muslims cannot acquire), **GH CBI** (NEVER OFFERED — constitutional 50-year leasehold cap precludes investment-citizenship).
