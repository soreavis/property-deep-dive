...
- **Foreign-buyer rule** — governed by [建设部/商务部/外汇局 171号文 2006 (Opinion No. 171 of 2006)](http://www.mohurd.gov.cn/) plus local-government implementation. Headline regime, post-September 2024 nationwide easing:
  ...
  - Local overlay in tier-1 cities (post-Sept 2024 easing; verify with the relevant 住建委 — local Housing Bureau):
    - **北京 (Beijing)**: non-Beijing-Hukou residents (incl. foreigners) require **2 consecutive years** of social-security or individual-income-tax payment inside the 5th Ring Road and **1 year** outside it (京建发〔2025〕565号, in force 24 Dec 2025, 现行有效 — [北京住建委](http://zjw.beijing.gov.cn/)); the **5-year** figure is the PRE-reform value (cut to 3 yrs inside / 2 yrs outside from 1 Oct 2024, then to the current bands). Since **8 Aug 2025** purchases **outside** the 5th Ring are unlimited in number for 1-yr payers (2026-08-07 verified, source: Beijing Housing Bureau)
...
- **Local Hukou / social-security overlay** in tier-1 cities (2026-08-07 verified): Beijing **2-yr inside the 5th Ring / 1-yr outside** (京建发〔2025〕565号, in force 24 Dec 2025; outside-5th-Ring purchases unlimited in number for 1-yr payers since 8 Aug 2025); Shanghai **1-yr citywide** (outside the outer ring from 1 Oct 2024, inside it only from 26 Feb 2026 per 沪七条); Shenzhen **1-yr** with district-differentiated unit caps (深建字〔2025〕199号, eff. 6 Sep 2025; no qualification check at all in 盐田 / 大鹏); Guangzhou no restriction (穗府办函〔2024〕65号, from 30 Sep 2024) — verify with each city's 住房保障和房产管理局 / 住建委 at time of offer
