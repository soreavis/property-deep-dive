...
**Restricted occupations**: under the **Emergency Decree on Managing the Work of Aliens B.E. 2560 (2017), as amended** (พระราชกำหนดการบริหารจัดการการทำงานของคนต่างด้าว พ.ศ. 2560 — this replaced the Alien Employment Act B.E. 2521 (1978)) and the Ministry of Labour notification on work prohibited to foreigners, **40 works are specified: 27 absolutely closed to foreigners and 13 open subject to conditions** (List 2 — accounting, engineering and architecture, only under an international agreement binding Thailand; List 3 — craft/semi-skilled work, employer required; List 4 — labouring and shop-sales work, employer required and entry under a government-to-government MOU). Absolutely closed works include wood carving, non-mechanised motor-vehicle driving (forklift excepted), auctioneering, hairdressing/beautician work, Thai massage, Thai musical-instrument making, Buddha-image making and legal services (2026 data, source Ministry of Labour / Department of Employment; 2026-09-18 verified). Full list: `https://www.doe.go.th` (verify current list — periodically updated).
