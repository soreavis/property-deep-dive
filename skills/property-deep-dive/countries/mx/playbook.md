...
- **CDMX Airbnb Law Oct 2024** — host + platform registries (Padrón de Anfitriones + Plataformas) went LIVE via Gaceta Oficial CDMX 22 May 2026, folio deadline ~20-21 Jun 2026 (pre-World Cup); 50 % annual occupancy cap (April 2024 amendment) contested — Airbnb + host amparos, suspensión definitiva in some cases so cap not applied pending trial (verified 2026-07-02)
