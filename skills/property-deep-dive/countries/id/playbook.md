...
- **OTA platform NIB verification (2026, industry-reported)**: villas listed on Airbnb / Booking.com / Expedia are being pushed to show a verified **NIB (Nomor Induk Berusaha)** or risk delisting. The verification deadline **was 31 Mar 2026**; it has reportedly been extended — variously to 31 May 2026 and to Aug 2026 per platform/industry sources — but this is **government-unconfirmed and enforcement is inconsistent**. Foreigners **cannot legally hold a Pondok Wisata licence** (Permenpar 18/2016 reserves it to Indonesian citizens); the compliant listing path is a **PT PMA** villa licence under **KBLI 55193**. Secondary/industry sources — verify current status with the platform and your PPAT.
...
**Confidence**:
- **HIGH** — foreign-ownership rules (UUPA §21, §26(2), §41; PP 18/2021), Hak Pakai term and conversion mechanics, SHMRS condo eligibility, Second Home Visa IDR 2B deposit (Permenkumham 22/2023; the property-route value is MEDIUM at best — contested in secondary sources, verify at Imigrasi), BPHTB 5 % ceiling and PPh Final 2.5 % framework, BNPB / BMKG / PVMBG hazard sources, nominee voidance risk (multiple Mahkamah Agung and Pengadilan Negeri precedents 2023–2025).
