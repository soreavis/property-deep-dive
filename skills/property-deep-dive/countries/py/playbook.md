...
- **Foreign ownership**:
  ...
  - **Border-zone restriction** — **Ley 2.532/2005** + amendments (incl. Ley 5.353/2014, Ley 6.286/2019): within **50 km of national borders**, foreign individuals + foreign-controlled entities **CANNOT acquire RURAL land** (terreno rural). Concessions limited to Paraguayan citizens or majority-PY-owned juridical persons. **Urban parcels** in border cities (Ciudad del Este, Encarnación, Pedro Juan Caballero, Salto del Guairá, etc.) **remain available** to foreign individuals.
...
- **Recent reforms (anchor — full timeline in `shared/regulatory-watch.md`)**:
  - **Ley 6.380/2019** — "Ley de Modernización y Simplificación del Sistema Tributario Nacional" — consolidated IRP (Impuesto a la Renta Personal), IRE (Impuesto a la Renta Empresarial), IDU (Impuesto a Dividendos y Utilidades), IVA structure. Effective 2020.
  - **Ley 5.811/2017** — Marco regulatorio de la construcción (Construction Code).
  - **Resolución SET 1186/2023** (Subsecretaría de Estado de Tributación, MEF) — tightened **Permanent Residency** requirements. Until 2022, ~USD 5,200 BNF deposit was sufficient → 2023 reform requires either active SET RUC + economic activity OR investment ≥ **USD 70,000** in business via SUACE.
