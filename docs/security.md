...
The seven mandatory pre-output checks are documented in [`shared/anti-hallucination.md`](../shared/anti-hallucination.md). Forbidden phrasings (e.g. "approximately X", "industry average", "experts say") are blocked at CI.
