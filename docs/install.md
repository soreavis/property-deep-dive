...
cd ~/code/property-deep-dive
git fetch --tags
git checkout 2026.06.0     # or any later tag — see CHANGELOG.md
```
...
```bash
gh release download 2026.06.0 --repo soreavis/property-deep-dive \
  --pattern 'property-deep-dive-2026.06.0.tar.gz' \
  --pattern 'property-deep-dive-2026.06.0.tar.gz.sigstore'

cosign verify-blob \
  --bundle property-deep-dive-2026.06.0.tar.gz.sigstore \
  --certificate-identity-regexp 'https://github\.com/soreavis/property-deep-dive/\.github/workflows/sign-release\.yml@.*' \
  --certificate-oidc-issuer 'https://token.actions.githubusercontent.com' \
  property-deep-dive-2026.06.0.tar.gz
```
