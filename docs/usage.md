...
The skill detects France by postcode, loads `skills/property-deep-dive/countries/fr/playbook.md`, runs all 30 sections (price · traffic · tax · rental · work · risks · mains · crime · amenities · climate · finance · currency · visa · insurance · notary · permits · agent · scams · language · connectivity · home-tax · remote · relocation · compare · retirement · digital-nomad · macro · demographics · esg · exit), and prints to terminal.
