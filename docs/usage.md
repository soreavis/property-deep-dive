...
The skill detects France by postcode, loads `skills/property-deep-dive/countries/fr/playbook.md`, runs all 27 sections (price · traffic · tax · rental · work · risks · mains · crime · amenities · climate · finance · currency · visa · insurance · notary · permits · agent · scams · language · connectivity · compare · retirement · digital-nomad · macro · demographics · esg · exit), and prints to terminal.
