...
The bar is **FR/IT/CZ/SK density** (~400-500 lines, all 33 sections covered with primary government sources — note: --crime/amenities/climate/permits/agent/scams/language/connectivity/home-tax/cross-border/remote/relocation/schools inherit from `shared/`, country playbook implements 7 core sections). See `skills/property-deep-dive/countries/fr/playbook.md` as the canonical example.
