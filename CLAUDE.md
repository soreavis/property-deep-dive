...
2. **Ask if the user's request collides with the anti-hallucination contract**: e.g., "fill in tax rates for all 87 countries quickly" without sources — that's slot-filling. Push back, propose research-first.
