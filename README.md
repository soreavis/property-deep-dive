...
**Repo total**: 227 markdown files, ~109,000 lines (skill content + community / governance files + CHANGELOG) · 40 YAML config files (32 workflows + 5 issue forms + dependabot + labels + labeler).
